<?php
/**
 * This .ds is similar to inc.ds.php execept, durations are short
...
function get_random_instrument($instrument_data=[]): array
{
	...
	// -12 to 100, mostly 0
	$instrument["general_stretch"] = $rr->ranger(40, 200, 0.10, false); // %
	...
	$instrument["noiseband1_f"] = $rr->ranger(500, 64000, 100);
	...
	$overtones_envelope1 = $rr->ranger(1000, 44000, 500);
	...
	$instrument["tone_f1"] = $rr->ranger(100, 999, 10, true);
	$instrument["tone_f2"] =  floor($instrument["tone_f1"]/$rr->ranger(1, 5, 0.01, true)); // $rr->ranger(0, 1000, 0.10, false); // half? - tenth?
	...
	$instrument["distortion_clipping"] = $rr->ranger(0, 40, 1, true); // https://github.com/LMMS/lmms/blob/master/src/core/DrumSynth.cpp#L437
